"""
CSV Source Loader Module - Shared across all phases
...
class CSVSourceManager:
    ...
    def __init__(self, csv_path: str = None):
        if csv_path is None:
            # Default to the shared config directory
    ...
    def get_source_for_answer(self, fund_name: str, data_type: str) -> Optional[str]:
        """
        Get the source URL for a specific fund and data type.
        This is used to return the correct URL in chatbot responses.
        """
        return self.get_url(fund_name, data_type)
...
if __name__ == "__main__":
    ...
    print("\n=== Source for Answer (Axis Large Cap Fund, NAV) ===")
    print(manager.get_source_for_answer("Axis Large Cap Fund", "NAV"))
