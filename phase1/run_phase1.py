"""
Phase 1: Data Ingestion Runner
Scrapes data from Groww.in and AxisMF.com
"""
...
def main():
    ...
    groww_scraper = GrowwScraper(csv_manager, use_selenium=False)  # Set to True if needed
    ...
    print("-" * 60)
    print("\nGroww.in Data (with Source URLs):")
    ...
    print("\nAxisMF.com Data (with Source URLs):")
